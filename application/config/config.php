...
switch( ENVIRONMENT_ ) {
    ...
    case 'development':
        define('ACTIVE_DB_GROUP', 'development');
        error_reporting(E_ALL);
        break;
    
    case 'testing':
        define('ACTIVE_DB_GROUP', 'testing');
        error_reporting(E_ALL);
        break;
    
    case 'production':
        //echo '----';
        define('ACTIVE_DB_GROUP', 'production');
        error_reporting(0);
        break;
}
...
|
*/
$config['sess_table_name'] = 'ci_sessions'; // custom variable for storing table name of the sessions table
                                            // also, is a fallback variable as per migration docs
                                            // http://www.codeigniter.com/userguide3/installation/upgrade_300.html


$config['sess_driver'] = 'database';
$config['sess_cookie_name'] = 'fom_li_ti_jo_na';
$config['sess_expiration'] = 900; // 15 minutes
$config['sess_save_path'] = $config['sess_table_name'];
