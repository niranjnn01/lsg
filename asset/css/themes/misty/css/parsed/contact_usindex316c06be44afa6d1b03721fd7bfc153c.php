...
width:300px;
height:<?php echo $captcha_img_height;?>px;
}
.captcha_refresh{
width:36px;
height:22px;
...
}#submitting{display:none;float:right;margin:0px 20px 0 60px;font-size:14px;}
#submitting img{float:left;margin-right:5px;}