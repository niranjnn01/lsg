...
class Common_model extends CI_Model{
	 ...
	 * 
	 */
	function generateToken_new($sPurpose,$sUniqueidentification, $iLength=20, $iLifeTime=3600, $sPool='', $bStrictPool = false) {
		...
		$sToken = '';
			...
			do{
				$sToken = random_string('alnum', $iLength, $sPool, $bStrictPool);
			}
			...
			if($oToken = $this->db->get('tokens_new')->row()){
				
				//update this record
				$this->db->where('id', $oToken->id);
