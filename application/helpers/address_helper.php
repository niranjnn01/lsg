<?php if (! defined ( 'BASEPATH' ))	exit ( 'No direct script access allowed' );
    ...
    function getAddressCreateForm() {
        ...
        $aConfig = array(
                        'table' => 'states',
                        'aWhere' => array('country_id' => $CI->mcontents['address_form_settings__iDefaultCountry']),
                        );
        ...
        $aConfig = array(
                        'table' => 'cities',
                        'aWhere' => array('state_id' => $CI->mcontents['address_form_settings__iDefaultState']), 
                        );
    ...
    function getAddressUpdateForm($iAddressUid) {
        ...
        $CI->mcontents['oAddressItemForEdit'] = $CI->address_model->getAddressDetails($iAddressUid);
